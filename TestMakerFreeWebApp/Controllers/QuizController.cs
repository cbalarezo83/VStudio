...
namespace TestMakerFreeWebApp.Controllers
{
    ...
    public class QuizController : Controller
    {
        ...
        public IActionResult Latest(int num = 10) {
            ...
            return new JsonResult(sampleQuizzes, new Newtonsoft.Json.JsonSerializerSettings() { Formatting = Formatting.Indented });
        ...
        public IActionResult ByTitle(int num = 10) {
            ...
            return new JsonResult(sampleQuizzes.OrderBy(t => t.Title), new Newtonsoft.Json.JsonSerializerSettings() { Formatting = Formatting.Indented });
        ...
        public IActionResult Random(int num = 10)
        {
            ...
            return new JsonResult(sampleQuizzes.OrderBy(t => Guid.NewGuid()), new Newtonsoft.Json.JsonSerializerSettings() { Formatting = Formatting.Indented });
